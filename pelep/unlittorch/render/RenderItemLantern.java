...
{
    public static ModelLantern entity = new ModelLantern().entity();
    public static ModelLantern equipped = new ModelLantern();
    ...
    public void renderItem(ItemRenderType type, ItemStack ist, Object... data)
    {
        ...
        else if (type == ItemRenderType.EQUIPPED_FIRST_PERSON)
        {
            ...
            if (handle)
            {
                ...
                equipped.renderAsEquipped(true);
            ...
            else
            {
                ...
                equipped.renderAsEquipped(false);

...
public class ConfigCommon extends UtilConfig
{
    ...
    public void load()
    {
        ...
        this.setCategory("IGNITERS", comment);
        igniterIdsHeld = this.getString("TorchHeld", igniterIdsHeld, "IDs and metadata of blocks that can ignite HELD torches");
        igniterIdsSet = this.getString("TorchSet", igniterIdsSet, "IDs and metadata of blocks/items that can ignite SET torches");

        this.setCategory("MOBS");
